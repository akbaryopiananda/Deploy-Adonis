...
export default class VenuesController {
   ...
   * /api/v1/venues:
   *   post:
   *     description: Storing new venue data (only venue_owner role authorized)
   *     security:
   *       - bearerAuth: []
   *     tags:
   *       - Venues
   ...
   * /api/v1/venues/{id}:
   *   put:
   *     description: Updating spesific venue (only venue_owner role authorized AND the creator of the venue)
   *     security:
   *       - bearerAuth: []
   *     tags:
   *       - Venues
